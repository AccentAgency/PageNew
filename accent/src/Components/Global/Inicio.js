...
class Inicio extends Component {
    ...
    render(){
        ...
        if(!this.state.imageStatus === "loaded") return <div className="centrado"><img src={gif} alt="cargando"></img></div>;
        return(
            <div className="">
                            ...
                            <div className='contenedor'>
                                <Carousel showArrows={false} showStatus={false} showThumbs={false} selectedItem={this.state.select}>
                                    ...
                                    <div className="slider3 col-md-12 col-lg-12">
                                        ...
                                        <div className="content-image col-xs-12 col-md-6 col-lg-6">
                                            <img className="img-responsive" src={disenograf} alt="diseño grafico" onLoad={this.handleImageLoaded2.bind(this)}
                                                onError={this.handleImageErrored2.bind(this)}></img>
                                        </div>
